                    ...
                    if(!document.getElementById('box-1').checked)
                    {
                      ...
                      if(document.getElementById('loader_container').style.display == "block")
                      {
                        ...
                        var x = setInterval(function()
                        {
                          ...
                          xmlhttp.open("GET", "/association/signup?mode=1&f_name=" +f_name+"&l_name="+l_name+"&email="+email+"&country_code="+country_code.toString()+"&mobile_number="+mobile_no.toString()+"&password="+password+"&consent_letter="+consent_letter, false);
                          xmlhttp.send(null);
                          ...
                          if(obj.res == 1)
                          {
                            ...
                            window.location = "/association/welcome_email";
                          }
                          else {
                            document.getElementById('loader_container').style.display = "none";
                            Swal.fire({
...
function change_country(x)
{
    ...
    // alert(v);
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", "/association/signup?mode=2&v=" +v, false);
    xmlhttp.send(null);
    var res = xmlhttp.responseText;
    // alert(res)
